 ...
 * </p>
 * <ul>
 *   <li>{@link emmm.impl.DataFeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link emmm.impl.DataFeatureImpl#getDtype <em>Dtype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataFeatureImpl extends MinimalEObjectImpl.Container implements DataFeature {
	/**
	...
	protected EClass eStaticClass() {
		return EmmmPackage.Literals.DATA_FEATURE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmmmPackage.DATA_FEATURE__NAME, oldName, name));
	}
	...
	public void setDtype(DataType newDtype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmmmPackage.DATA_FEATURE__DTYPE, oldDtype, dtype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmmmPackage.DATA_FEATURE__NAME:
				return getName();
			case EmmmPackage.DATA_FEATURE__DTYPE:
				return getDtype();
		}
