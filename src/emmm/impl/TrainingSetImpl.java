 ...
 * </p>
 * <ul>
 *   <li>{@link emmm.impl.TrainingSetImpl#getDataset <em>Dataset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrainingSetImpl extends AssetImpl implements TrainingSet {
	/**
	...
	protected EClass eStaticClass() {
		return EmmmPackage.Literals.TRAINING_SET;
	}
		...
		if (dataset != null && dataset.eIsProxy()) {
			...
			if (dataset != oldDataset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmmmPackage.TRAINING_SET__DATASET, oldDataset, dataset));
			}
		}
		return dataset;
	}
	...
	public void setDataset(Dataset newDataset) {
		...
		dataset = newDataset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmmmPackage.TRAINING_SET__DATASET, oldDataset, dataset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmmmPackage.TRAINING_SET__DATASET:
